...
function UserProfileDialog() {
    ...
    const ViewProfile = () => {
        let top = "30%"
        if (menuName == "ServiceProviderPage") {
            top = "10%"
        }
                ...
                <div className='column'>
                    ...
                    <button className="custombutton common-bg mx-2 mt-3" onClick={() => {
                        ...
                        if (newPassword.length < 8 || confirmPassword.length < 8) {
                            ...
                            dispatch(UserPasswordUpdate(body, menuName))
                        } else {
                ...
                <div className="row p-0 g-0" >
                    ...
                    <div className="column g-0" style={{ width: '600px' }}>
                        ...
                        {viewProfile ? <div> {ViewProfile()} </div> :
                            ...
                            editProfile ? menuName == "ServiceProviderPage" ? <div> {SPEditProfile()} </div> : <div> {EditProfile()} </div> :
